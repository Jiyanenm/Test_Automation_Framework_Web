...
public class BrowserUtils {
    ...
    public  static  void popUpVisibile(WebElement element)
    {
        // Wait for modal to be visible
        WebDriverWait wait = new WebDriverWait(Driver.get(), Duration.ofSeconds(10));
        WebElement modal = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[2]")));

// Now you can interact with elements inside the modal
        WebElement closeButton = modal.findElement(By.className("close"));
        closeButton.click(); // or do other interactions
    }
